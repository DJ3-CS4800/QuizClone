...
public class DeckController {
    ...
    @Operation(description = "Retrieves all study decks owned by the current user.")
    @ApiResponses({
    ...
    @Operation(description = "Creates a new study deck with the given name and description.")
    @ApiResponses({
    ...
    @Operation(description = "Retrieves the specified study deck by its ID.")
    @ApiResponses({
    ...
    @Operation(description = "Updates the name and description of the specified study deck.")
    @ApiResponses({
    ...
    @Operation(description = "Deletes the specified study deck.")
    @ApiResponses({
    ...
    @GetMapping("/search")
    @Operation(description = "Searches for study decks based on a query string.")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Decks retrieved successfully"),
    })
